...
bool CWallet::SetAddressBookName(const CTxDestination& address, const string& strName)
{
    ...
    NotifyAddressBoWLChanged(this, address, strName, ::IsMine(*this, address), (mi == mapAddressBook.end()) ? CT_NEW : CT_UPDATED);
    if (!fFileBacked)
        return false;
...
bool CWallet::DelAddressBookName(const CTxDestination& address)
{
    ...
    NotifyAddressBoWLChanged(this, address, "", ::IsMine(*this, address), CT_DELETED);
    if (!fFileBacked)
        return false;
