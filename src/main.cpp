...
unsigned int nStakeMaxAge = 60 * 60 * 24 * 7;	// stake age of full weight: 30d
unsigned int nStakeTargetSpacing = 10;			// 60 sec block spacing

int64 nChainStartTime = 1463732193;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "The Times 26/Feb/2016 Chancellor on brink of second bailout for banks";
        CTransaction txNew;
		...
		block.print();
        assert(block.hashMerkleRoot == uint256("779295ee4de9899ec83eaaaf6a91138e26fd6b940ea969d237652c5c14e2c929"));
